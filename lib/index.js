...
function (_super) {
  ...
  function ImageClip(props, ctx) {
        ...
        return tslib_1.__generator(this, function (_b) {
          switch (_b.label) {
            case 0:
              ...
              fixedViewPort = (0, _helpers.prefixClipInfo)({
                x: left,
                y: top,
                height: height,
                width: width
              ...
              return [4
              /*yield*/
              , (0, _helpers.clipImageByPosition)(this.image, clipInfo.x, clipInfo.y, clipInfo.width, clipInfo.height, this.props.imageType || 'jpeg', this.props.quality || 1, this.props.canOverClip ? this.props.fillColor : null, this.props.canOverClip ? this.state.backgroundPositionX * this.scaleRatio : 0, this.props.canOverClip ? this.state.backgroundPositionY * this.scaleRatio : 0)];
    ...
    _this.handleDragStart = function (e) {
      ...
      if (e.touches && e.touches.length === 2) {
        ...
        _this.thumbOriginDistance = (0, _helpers.distanceOfPoints)(e.touches[0].clientX, e.touches[0].clientY, e.touches[1].clientX, e.touches[1].clientY);
        _this.moveStartPos = {
          x: NaN,
          y: NaN,
      ...
      _this.timer = window.setTimeout(function () {
        ...
        _this.movePosRange = (0, _helpers.calcOffsetEdge)(_this.props.canOverClip ? 0 : _this.state.backgroundPositionX, _this.props.canOverClip ? 0 : _this.state.backgroundPositionY, _this.containerWidth, _this.props.canOverClip ? _this.state.containerHeight : _this.state.backgroundSizeHeight, _this.state.viewportPos.left, _this.state.viewportPos.top, _this.state.viewportPos.width, _this.state.viewportPos.height, 'move');
    ...
    _this.handleResizeDragOver = function (e) {
      ...
      if (!_this.state.isResizing) {} else if (e.touches && e.touches.length === 2 && _this.thumbOriginDistance > 0) {
        e.stopPropagation();
        e.preventDefault();
        var delta = (0, _helpers.distanceOfPoints)(e.touches[0].clientX, e.touches[0].clientY, e.touches[1].clientX, e.touches[1].clientY); // 写死 45 度角缩放
        ...
        _this.setState(function (s) {
          ...
          var _a = (0, _helpers.calcScalePos)(_this.moveStartPos.viewportOriginPos.left, _this.moveStartPos.viewportOriginPos.top, _this.moveStartPos.viewportOriginPos.width, _this.moveStartPos.viewportOriginPos.height, offset_1.x, offset_1.y, _this.anchorType, _this.props.ratio),
              x = _a.x,
              y = _a.y,
              width = _a.width,
              height = _a.height;
    ...
    _this.fireChange = function () {
      if (typeof _this.props.onChange === 'function') {
        var _a = _this.state.viewportPos,
            ...
            height = _a.height,
            width = _a.width;
        var fixedViewPort = (0, _helpers.prefixClipInfo)({
          x: left,
          y: top_1,
          height: height,
          width: width
      ...
      return tslib_1.__generator(this, function (_b) {
        switch (_b.label) {
          ...
          case 5:
            ...
            layoutInfo = (0, _helpers.calcContainerSize)(this.props.ratio, this.props.canOverClip, this.containerWidth, this.image.naturalWidth, this.image.naturalHeight);
  ...
  Object.defineProperty(ImageClip.prototype, "min", {
    get: function get() {
      var width = (0, _helpers.getDistance)(this.props.minWidth || '37%', this.containerWidth, this.image.naturalWidth);
      var height = (0, _helpers.getDistance)(this.props.minHeight || '37%', this.state.containerHeight, this.image.naturalHeight);
